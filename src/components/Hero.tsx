        ...
        <main className="relative z-10 max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-12 ">
            ...
            Transform Bussinesses</span>  
                ...
                <div className="flex space-x-10">
                    <button className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-linear-to-r from-blue-500 to-cyan-500 text-base font-bold text-white shadow-2xl hover:shadow-blue-500/50 transition-all">Get Started Free</button>
                    <button className=" inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white/5 border-2 border-white/20 text-base font-semibold text-white backdrop-blur-md hover:bg-white/10 transition-all">View Protfolio</button>
                </div>
